...
import com.yus.taobaoui.RegisterActivity;
import com.yus.taobaoui.view.ClothesActivity;
import com.yus.taobaoui.view.MD5Utils;
...
public class login_activity extends AppCompatActivity{
    ...
    private void init() {
        ...
        //String textStr="<font color=\"#FF0000\">"+"登录"+"</font>";
        // tv_main_title.setText(Html.fromHtml(textStr));
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(userName)){
                    ...
                    startActivity(new Intent(login_activity.this, Home2Activity.class));
                    return;
                }else if((spPsw!=null&&!TextUtils.isEmpty(spPsw)&&!md5Psw.equals(spPsw))){
                    Toast.makeText(login_activity.this, "输入的用户名和密码不一致", Toast.LENGTH_SHORT).show();
                    return;
                }else{
                    Toast.makeText(login_activity.this, "此用户名不存在", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
